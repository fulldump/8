<?php
	 ...
	 * Location: class/SystemTemplate.class.php
	 * Date: Mon, 24 Feb 2014
	 * Author: gerardooscarjt@gmail.com
	 * Typical use:
	 * $my_component = SystemTemplate::INSERT('my_component');
	...
	*/
	...
	class SystemTemplate {
		...
		protected static $dir_base = 'template';
		...
		public static function get($name) {
			if (!array_key_exists($name, self::$data)) {
				...
				if ('' != $name && file_exists($path)) {
					self::$data[$name] = new SystemTemplate($name);
				} else {
					return null;
				}
			}
