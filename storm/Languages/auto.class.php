<?php
  ...
  array (
    ...
    'native' => false,
		...
		// Setters and Getters
public function setCode($value) { $this->row['Code'] = $value; $value = Database::escape($value); $timestamp = time(); $sql = "UPDATE `Languages` SET `Code`='$value',`__timestamp__` = $timestamp, `__operation__` = 'UPDATE' WHERE `id`='{$this->id}'"; Database::sql($sql);} public function getCode() { return $this->row['Code']; }
