<?php
  ...
  array (
    ...
    'native' => true,
		...
		// Setters and Getters
public function setText($value) { $this->row['Text'] = $value; $value = Database::escape($value); $timestamp = time(); $sql = "UPDATE `Cron` SET `Text`='$value',`__timestamp__` = $timestamp, `__operation__` = 'UPDATE' WHERE `id`='{$this->id}'"; Database::sql($sql);} public function getText() { return $this->row['Text']; }
